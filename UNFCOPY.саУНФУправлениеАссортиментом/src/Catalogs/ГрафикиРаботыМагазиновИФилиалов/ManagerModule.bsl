...
Процедура СозадьПредопреденныеШаблоныГрафиков() Экспорт
	...
	ГруппаШаблоновПоДнямНедели = Справочники.ШаблоныЗаполненияГрафиковМагазиновИФилиалов.СоздатьГруппу();
	ГруппаШаблоновПоДнямНедели.Наименование = "Шаблоны по дням недели";
	
	ГруппаШаблоновСменные = Справочники.ШаблоныЗаполненияГрафиковМагазиновИФилиалов.СоздатьГруппу();
	...
	// По дням Неделеи
	НовыйШаблонПятидневка = Справочники.ШаблоныЗаполненияГрафиковМагазиновИФилиалов.СоздатьЭлемент();
	...
	НовыйШаблонШестидневка = Справочники.ШаблоныЗаполненияГрафиковМагазиновИФилиалов.СоздатьЭлемент();
	...
	//Сменные
	НовыйШаблонСменный2через2_12 = Справочники.ШаблоныЗаполненияГрафиковМагазиновИФилиалов.СоздатьЭлемент();
	...
	НовыйШаблонЖД = Справочники.ШаблоныЗаполненияГрафиковМагазиновИФилиалов.СоздатьЭлемент();
	...
	НовыйШаблонСменныйСуткиТрое = Справочники.ШаблоныЗаполненияГрафиковМагазиновИФилиалов.СоздатьЭлемент();
...
Процедура ОбновитьГрафикиУчетаРабочегоВремени() Экспорт
	...
	|ПОМЕСТИТЬ ВТГрафики
	|ИЗ
	|	Справочник.ГрафикиРаботыМагазиновИФилиалов КАК ГрафикиРаботы
	|
	|СГРУППИРОВАТЬ ПО
	...
	Пока ВыборкаГрафиков.Следующий() Цикл
		...
		НовыйШаблон = Справочники.ШаблоныЗаполненияГрафиковМагазиновИФилиалов.СоздатьЭлемент();
