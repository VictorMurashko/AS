...
Процедура ОбновитьПанельКонтактнойИнформацииСервер()
	...
	Если НЕ ЗначениеЗаполнено(ТекущийКурьер) И ЗначениеЗаполнено(Элементы.Список.ТекущаяСтрока.ВодительПосторонний) Тогда
	
		ТекущийКурьер =  Элементы.Список.ТекущаяСтрока.ВодительПосторонний;
